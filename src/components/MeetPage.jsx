        ...
        <div>
            <div className="hidden md:hidden lg:flex mt-14 bg-[#FFC0FF] h-fit px-12 ">
                ...
                <div className="flex-1 grid place-content-center">
                    <div className="flex flex-col w-[723px] ">
                        <p className='font-apfel text-5xl text-nowrap text-[#101828]'>Meet Your New Beauty Bestie!</p>
            ...
            <div className="hidden md:flex lg:hidden  mt-14 bg-[#FFC0FF] px-6 py-16">
                <div className="flex flex-col ">
                    <p className='font-apfel text-[40px] text-nowrap text-[#101828]'>Meet Your New Beauty Bestie!</p>
            ...
            <div className="flex md:hidden lg:hidden mt-14 bg-[#FFC0FF] px-4 py-14 w-full">
                <div className="flex flex-col ">
                    <p className='font-apfel text-[36px] text-[#101828]'>Meet Your New Beauty Bestie!</p>
