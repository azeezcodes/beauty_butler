                ...
                <div className="mx-auto mt-6">
                    <form action="https://getlaunchlist.com/s/52IebT"
                        ...
                        <div className="flex w-full gap-1">
                            ...
                            <input name="email" type="email" placeholder='Enter your email address' required className='h-[50px] euclidRegular placeholder:text-slate-400 placeholder:text-[12px] border border-[#F2F4F7] outline-none focus:ring-0 ring-0 focus:ring-transparent px-2 w-full rounded-[14px]' />
                        </div>
